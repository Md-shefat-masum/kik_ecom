    ...
    public function run(): void
    {
        ...
        $products = [
            [
                ...
                "image" => "ecom/products/notebook/golpo_somorga1/01.jpg"
            ],

            [
                "product_name" => "Golpo somorgo-3",
                "selected_categories" => 4,
                "image" => "ecom/products/notebook/golpo_somorga3/01.jpg"
            ],

            [
                "product_name" => "KK Kye Ring",
                "selected_categories" => 6,
                "image" => "ecom/products/key_ring/kk/updatKeyRing/01.jpg"
            ],

            [
                "product_name" => "কলম কি ক",
                "selected_categories" => 2,
                "image" => "ecom/products/pen/01.png"
            ],

            [
                "product_name" => "কলমদানি",
                "selected_categories" => 2,
                "image" => "ecom/products/pen_holder/01.png"
            ],

            [
                "product_name" => "কি ক পত্রিকা",
                "selected_categories" => 4,
                "image" => "ecom/products/newspaper/01.png"
            ],

            [
                "product_name" => "কিশোরকণ্ঠ কলম-2",
                "selected_categories" => 2,
                "image" => "ecom/products/kisorkantho_pen/01.png"
            ],

            [
                "product_name" => "কিশোরকণ্ঠ ঘড়ি",
                "selected_categories" => 3,
                "image" => "ecom/products/watch/03.png"
            ],

            [
                "product_name" => "কিশোরকন্ঠ নোটবুক",
                "selected_categories" => 4,
                "image" => "ecom/products/notebook/3.png"
            ],
            ...
            [
                ...
                "image" => "ecom/products/mug/01.png"
            ],
        ];
